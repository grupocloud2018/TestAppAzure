...
<body class="">
  <div class="wrapper ">
	...
	<b><font color="white"; size="4px";><i>PROJECT C</i></font></b>
	  ...
	  <li <?php if($pagina['pagina'] == "Conductores") echo "class=\"active\""; ?> >
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
	      ...
	      <h4 class="card-title"> An&aacute;lisis <?php echo $pagina['pagina']; ?> </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
		<iframe width="933" height="700" 
			src="<?php if($pagina['pagina']=='Conductores')
					echo "https://app.powerbi.com/view?r=eyJrIjoiMTU4MzY4YmUtMDhlMS00MWQ0LWJhNWMtNGFmYzE3YTk1YzBkIiwidCI6ImM3YTdjYTJhLTMyOWMtNGJiYy1hZmRiLTY2NmUxMTE4OWI4MyIsImMiOjR9";
				    elseif($pagina['pagina']=='Eventos')		
					echo "https://app.powerbi.com/view?r=eyJrIjoiNGE2MjM3MWYtMGEzYS00MGRiLTkzYTAtYzQyZjM0OTU1ODQzIiwidCI6ImM3YTdjYTJhLTMyOWMtNGJiYy1hZmRiLTY2NmUxMTE4OWI4MyIsImMiOjR9";
				    else 
					echo "https://app.powerbi.com/view?r=eyJrIjoiZGY4M2Q3NTQtY2E1Yy00YjA4LWI2MDktMWMzYTE4MDIwYTc4IiwidCI6ImM3YTdjYTJhLTMyOWMtNGJiYy1hZmRiLTY2NmUxMTE4OWI4MyIsImMiOjR9";
?>" 
  ...
  <script src="https://pruebajx.azurewebsites.net/TestApp/assets/js/plugins/bootstrap-notify.js"></script>
