  ...
  <div class="wrapper ">
	...
	PROJECT C
	  ...
	  <a href="<?php echo 'https://pruebajx.azurewebsites.net/TestApp/';?>">
          ...
          <li>
	  <a href="<?php echo 'https://pruebajx.azurewebsites.net/TestApp/index.php/Bdomsite/getAllConductores'; ?>">
              <i class="now-ui-icons design_bullet-list-67"></i>
              <p>Conductores</p>
            </a>
          </li>
          <li class="active ">
	    <a href="<?php echo 'https://pruebajx.azurewebsites.net/TestApp/index.php/Bdomsite/getAllVehiculos'; ?>">
              <i class="now-ui-icons text_caps-small"></i>
              <p>Veh&iacute;culos</p>
            </a>
          </li>
          <li>
            <a href="<?php echo 'https://pruebajx.azurewebsites.net/TestApp/index.php/Bdomsite/PWBI'; ?>">
              <i class="now-ui-icons text_caps-small"></i>
              <p>Power BI</p>
            </a>
          </li>
